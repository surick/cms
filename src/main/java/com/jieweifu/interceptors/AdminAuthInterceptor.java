...
public class AdminAuthInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String authToken = StringUtils.isNotBlank(request.getHeader(CommonConstant.TOKEN_AUTHORIZATION)) ?
                request.getHeader(CommonConstant.TOKEN_AUTHORIZATION) : request.getParameter(CommonConstant.TOKEN_AUTHORIZATION);
